 ...
 */
	...
	const EXCEPTION_DB_CONVERT_PERS = "ERROR CONVERSION DB ->PERS CONVERPERS";
    ...
    const EXCEPTION_INSERT_DB_PERS = "ERROR INSERT PERS in DATABASE";
    const EXCEPTION_INSERT_DB_LIVRE = "ERROR INSERT BOOK in DATABASE";
    //exception PDO update
    const EXCEPTION_DB_PERS_UP = "RECORD PERSONNE not update in DATABASE";
    const EXCEPTION_UPDATE_DB_LIVRE = "RECORD BOOk not update in DATABASE";
    //exception PDO update
